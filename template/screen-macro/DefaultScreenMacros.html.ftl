...
<#macro @element><p>=== Doing nothing for element ${.node?node_name}, in mode: HTML not yet implemented. ===</p></#macro>
...
<#macro "container-box">
    ...
    <div class="panel panel-${boxType}"<#if contBoxDivId?has_content> id="${contBoxDivId}"</#if>>
        ...
        <#if .node["box-body"]?has_content>
            <div class="panel-body"<#if .node["box-body"][0]["@height"]?has_content> style="max-height: ${.node["box-body"][0]["@height"]}px;"</#if>>
